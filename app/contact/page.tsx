...
export const metadata: Metadata = {
  ...
  description: 'Get in touch with Covenda. Sales, support, partnerships, or general inquiries—we respond within 24 hours.',
};
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-12">
              <div className="text-center p-6 bg-gray-50 rounded-lg border border-gray-200">
                ...
                <a href="mailto:hello@covenda.ai" className="text-accent hover:underline">
                  hello@covenda.ai
                </a>
              </div>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-gray-600 mb-3">
                    Interested in a demo, pilot, or partnership? Reach out to our team.
                  </p>
                  <a href="mailto:sales@covenda.ai" className="text-accent hover:underline font-medium">
                    sales@covenda.ai
                  </a>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-600 mb-3">
                    Existing customers: access support docs and submit tickets via the platform, or email:
                  </p>
                  <a href="mailto:support@covenda.ai" className="text-accent hover:underline font-medium">
                    support@covenda.ai
                  </a>
                </div>
                ...
                <div>
                  ...
                  <a href="mailto:security@covenda.ai" className="text-accent hover:underline font-medium">
                    security@covenda.ai
                  </a>
                </div>

                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-4">Careers</h3>
                  <p className="text-gray-600 mb-3">
                    Join the Covenda team. We're hiring FDEs, engineers, and go-to-market roles.
                  </p>
