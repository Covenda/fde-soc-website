...
import { ArrowRight, Shield, Zap, Users, GitBranch, Activity, Workflow } from "lucide-react";
...
const services = [
  {
    icon: Shield,
    title: "Assess",
    description: "Comprehensive security posture evaluation with actionable roadmap",
    features: [
...
const caseStudies = [
  {
    ...
    outcome: "Built cloud-native detection pipeline with automated triage, reducing analyst workload by 70%",
    metrics: [
  ...
  },
  {
    ...
    industry: "Technology",
    challenge: "No visibility into third-party dependencies and build pipeline risks",
    outcome: "Implemented continuous scanning and policy enforcement across 200+ repositories",
    metrics: [
  ...
  },
  {
    ...
    industry: "Healthcare",
    challenge: "HIPAA audit findings with insufficient logging and no incident response capability",
    outcome: "Deployed comprehensive logging, detection rules, and runbooks aligned with HIPAA requirements",
    metrics: [
      ...
      <Section className="bg-muted/30">
        <Container>
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            <Stat value="70%" label="Faster MTTD" description="Average detection time reduction" />
            <Stat value="24/7" label="Coverage" description="Co-managed operations" />
            <Stat value="2-4 wks" label="To Production" description="From assessment to first value" />
            <Stat value="50+" label="Integrations" description="Platform connectors" />
          </div>
        </Container>
      </Section>
      ...
      <Section>
        <Container>
          <div className="text-center mb-16">
            <h2 className="mb-4">Security engineering and operations as a service</h2>
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              From initial assessment to ongoing operations, we provide the people, process, and platform to build and run your security program.
            </p>
          </div>
      ...
      <Section className="bg-muted/30">
        <Container>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              The Covenda unified risk platform connects threat intelligence, controls, evidence, and automated response in a single ecosystem.
            </p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  1-3+ security engineers join your team in 2-week sprints. Daily standups, shared Slack channels, and collaborative development.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Custom Sigma rules, KQL/SPL queries, and automated runbooks tailored to your environment. All code-reviewed and tested.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Clear SLOs for MTTD, MTTR, and coverage. Exit criteria defined upfront. Metrics dashboards for continuous visibility.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <Section>
        <Container>
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              We've helped organizations build and operate world-class security programs with measurable outcomes.
            </p>
          </div>
          <div className="grid gap-8 md:grid-cols-3">
